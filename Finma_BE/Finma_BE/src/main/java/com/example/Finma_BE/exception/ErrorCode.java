...
public enum ErrorCode {
    ...
    INCORRECT_PASSWORD(10007, "Incorrect password", HttpStatus.BAD_REQUEST),
    DEBT_NOT_FOUND(10008, "Debt not found", HttpStatus.NOT_FOUND),
    RETURN_DATE_MUST_BE_AFTER_START_DATE(10009, "Return Date must be after start date", HttpStatus.BAD_REQUEST),
